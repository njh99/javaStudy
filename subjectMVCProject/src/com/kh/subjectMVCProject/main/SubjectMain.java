...
public class SubjectMain {
	...
	//학과정보
	private static void subjectMenu() throws SQLException, FileNotFoundException, IOException {
		int no;
	...
	//학생정보
	private static void studentMenu() throws SQLException, FileNotFoundException, IOException {
		int no;
